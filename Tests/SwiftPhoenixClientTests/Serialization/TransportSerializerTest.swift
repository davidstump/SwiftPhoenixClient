...
struct PhoenixTransportSerializerTest {
    ...
    struct EncodeSuite {
        ...
        @Test("binary throws error")
        func binaryThrowsError() throws {
            let message = OutgoingMessage(
                joinRef: "0",
                ref: "1",
                topic: "t",
    ...
    @Suite("binaryEncode")
    struct BinaryEncodeSuite {
        
        private let serializer: TransportSerializer = PhoenixTransportSerializer()
        private let payloadEncoder: PayloadEncoder = PhoenixPayloadEncoder()
        
        @Test("raw binary")
        func rawBinary() throws {
        ...
        @Test("variable length segments")
        func variableLengthSegments() throws {
