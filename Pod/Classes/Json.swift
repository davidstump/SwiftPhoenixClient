...
public class JSON {
  ...
  public class func unwrap(obj:Any) -> Any {
    switch obj {
  ...
  /// NSJSONSerialization
  public init(_ obj:Any) { self._value = JSON.unwrap(obj: obj) }
...
extension JSON {
  ...
  public class func stringify(obj:Any, pretty:Bool=false) -> String! {
...
extension JSON {
  ...
  public var allValues:JSON{
    let value = self._value as AnyObject
    if(value.allValues == nil) {
      return JSON([])
    }
    return JSON(value.allValues)
  }
